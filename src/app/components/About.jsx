    ...
    >
      ...
      <div className="flex flex-col gap-4">
        ...
        <p className="text-xl text-[#fee9ce]">
          ...
          innovation. Currently, I&apos;m pursuing a Full-Stack Software
          Development certificate from CodeX Academy. With a focus on building a
          strong foundation in coding, a knack for problem-solving, a keen eye
          for detail, and a commitment to continuous learning, I aim to deliver
          robust and user-centric software solutions. From front-end development
          to back-end solutions, I&apos;m constantly refining my skills to
          create seamless experiences for users. Let&apos;s connect and explore
